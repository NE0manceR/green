...
define('SITE_EMAIL', 'info@green'); // Від даної пошти сайт відправляє листи
define('SYS_PASSWORD', '9520955db072'); // Сіль для кешування критичних даних (паролі)
...
$_SESSION['all_languages'] = array('uk', 'ru', 'en'); // Список всіх  мов в масиві, перша мова - мова по замовчуванню
